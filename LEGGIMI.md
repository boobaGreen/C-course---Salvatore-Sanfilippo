...
- **Persistenza e Stato**: Gestione centralizzata del `localStorage` con namespacing (`c_course_`) e migrazione automatizzata dai vecchi formati di storage.
...
└── utils/          # Utility di storage, formattatori e helper
```
