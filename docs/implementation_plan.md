...
```mermaid
graph LR
    subgraph "Fondamenti L1-L5"
        L1["L1: Intro C<br>hello world"] --> L2["L2: Variabili<br>tipi base"]
        L2 --> A1["A1: Vita variabili<br>locali"]
        A1 --> L3["L3: Funzioni"]
        L3 --> L4["L4: Array<br>stringhe"]
        L4 --> L5["L5: Operatori<br>espressioni"]
    end

    subgraph "Controllo Flusso L6-L8"
        L5 --> L6["L6: IF, GOTO<br>Ricorsione"]
        L6 --> L7["L7: While, For<br>Switch"]
        L7 --> L8["L8: Game of Life<br>Progetto pratico"]
    end

    subgraph "Puntatori L9-L13"
        L8 --> L9["L9: Intro<br>Puntatori"]
        L9 --> L10["L10: Matematica<br>Puntatori"]
        L10 --> L11["L11: Chiarimenti"]
        L11 --> L12["L12: Malloc"]
        L12 --> L13["L13: Metadata<br>Trick"]
    end

    subgraph "Strutture L14-L17"
        L13 --> L14["L14: C Structs"]
        L14 --> L15["L15: Data<br>Structures"]
        L15 --> L16["L16: String Lib<br>Ref Count"]
        L16 --> L17["L17: Design<br>Choices"]
    end

    subgraph "Avanzato L18-L22"
        L17 --> S1["S1: Algoritmi<br>dalla memoria"]
        S1 --> L18["L18: Opaque Types<br>Typedef"]
        L18 --> L19["L19: System Calls"]
        L19 --> L20["L20: Buffering<br>mmap"]
        L20 --> L21["L21: Unions<br>Bitfields"]
        L21 --> L22["L22: Function<br>Pointers"]
    end

    subgraph "Toy Forth L23-L29"
        L22 --> L23["L23: Forth P1"]
        L23 --> L24["L24: Forth P2"]
        L24 --> L25["L25: Forth P3"]
        L25 --> L26["L26: Forth P4"]
        L26 --> L27["L27: Forth P5"]
        L27 --> S3["S3: Deep Dive<br>Ref Counting"]
        S3 --> L28["L28: Variadic<br>Functions"]
        L28 --> L29["L29: Forth Run"]
    end

    subgraph "Progetto Finale L30-L31"
        L29 --> L30["L30: ZX Spectrum<br>P1"]
        L30 --> L31["L31: ZX Spectrum<br>P2"]
    end
```
...
```mermaid
graph TB
    subgraph "Content Pipeline - Offline"
        YT["YouTube Videos<br>35 video, ~17.5h"] --> DL["Download Audio<br>yt-dlp → MP3"]
        DL --> TR["Trascrizione<br>Whisper small<br>GPU GTX 1650"]
        TR --> RAW["Testo Grezzo IT"]
        RAW --> AD["Adattamento LLM<br>Parlato → Scritto"]
        AD --> IT_T["Testo IT Curato"]
        AD --> EN_T["Traduzione EN<br>LLM + revisione"]
        IT_T --> MDX_IT["MDX Files IT<br>src/content/it/"]
        EN_T --> MDX_EN["MDX Files EN<br>src/content/en/"]
    end

    subgraph "Visual Assets"
        AI_GEN["generate_image tool"] --> INF["Infografiche PNG"]
        MERMAID["Mermaid.js"] --> DIAG["Diagrammi SVG"]
        CSS_ANIM["CSS + Framer Motion"] --> ANIM["Animazioni"]
    end

    subgraph "Code Execution - Browser"
        EMSC["Emscripten<br>Compilatore C → WASM"] --> EXEC["Esecuzione in-browser"]
        PRECALC["Output Pre-calcolato<br>per L19, L20, L26"] --> SHOW["Visualizzazione output"]
    end

    subgraph "Vite + React App"
        MDX_IT --> ROUTER["React Router v7"]
        MDX_EN --> ROUTER
        INF --> ROUTER
        DIAG --> ROUTER
        ANIM --> ROUTER
        EXEC --> ROUTER
        SHOW --> ROUTER
        ROUTER --> BUILD["Vite Build<br>→ Static HTML/JS/CSS"]
    end

    BUILD --> DEPLOY["Deploy<br>GitHub Pages / Netlify / Vercel<br>Qualsiasi hosting statico"]
```
